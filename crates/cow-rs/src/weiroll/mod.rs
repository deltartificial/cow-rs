...
//! chaining arbitrary EVM calls into a single transaction. This module
...
//! | [`create_weiroll_delegate_call`] | Build a complete `execute(...)` [`EvmCall`](crate::config::chains::EvmCall) |
