...
impl WeirollCommand {
    ...
    /// use cow_rs::weiroll::WeirollCommand;
    ///
...
///
/// ```
/// use cow_rs::weiroll::WeirollPlanner;
///
...
/// ```
/// use alloy_primitives::Address;
/// use cow_rs::weiroll::{WEIROLL_ADDRESS, WeirollCommand, create_weiroll_delegate_call};
///
...
/// ```
///
/// [`WEIROLL_ADDRESS`]: crate::weiroll::WEIROLL_ADDRESS
#[must_use]
