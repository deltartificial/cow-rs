...
impl InteractionLike {
    ...
    /// use cow_rs::order_signing::interaction::InteractionLike;
    ///
...
/// use cow_rs::order_signing::interaction::{InteractionLike, normalize_interaction};
///
...
/// ```
/// use alloy_primitives::Address;
/// use cow_rs::order_signing::interaction::{InteractionLike, normalize_interactions};
///
/// let interactions =
