...
impl SettlementTokenRegistry {
    ...
    /// use cow_rs::order_signing::trade::SettlementTokenRegistry;
    ///
...
/// use cow_rs::order_signing::trade::{SettlementTokenRegistry, Swap, encode_swap_step};
///
/// let mut tokens = SettlementTokenRegistry::new();
/// let swap = Swap {
///     pool_id: B256::ZERO,
...
/// use cow_rs::order_signing::trade::{Eip1271SignatureData, encode_eip1271_signature_data};
///
...
/// ```
/// use alloy_primitives::{Bytes, address};
/// use cow_rs::order_signing::trade::{
