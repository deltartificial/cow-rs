...
/// [`CowHook`](cow_types::CowHook) ready to attach to an order's
/// app-data.
///
...
impl FlashLoanSdk {
    ...
    /// Build a [`CowHook`](cow_types::CowHook) that triggers a flash
    ...
    /// [`CowHook`](cow_types::CowHook) with a default gas limit of
    /// `500_000`.
    ///
    /// # Parameters
    ///
    ...
    pub fn build_flash_loan_hook(
        ...
        receiver: Address,
        user_data: &[u8],
    ) -> Result<cow_types::CowHook, CowError> {
